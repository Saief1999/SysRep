...
public class ClientView extends JFrame {
    ...
    /**
     *  This method is used to update the textField from the network
     *  with each update , we need to remove the listener to prevent resending the message
     *  again , and then we add it again
     */
    public void updateTextFieldNetwork(String newText)
    {
